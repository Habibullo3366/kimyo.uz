...
public class CategoryController implements SimpleRequestCrud<Integer, RequestCategoryDto, ResponseCategoryDto> {
    ...
    public ResponseEntity<ResponseDto<ResponseCategoryDto>> createEntity(@RequestBody  RequestCategoryDto entity) {
    ...
    public ResponseEntity<ResponseDto<ResponseCategoryDto>> getEntity(@PathVariable(value = "id") Integer entityId) {
    ...
    public ResponseEntity<ResponseDto<ResponseCategoryDto>> updateEntity(@RequestParam(value = "id") Integer entityId,
                                                                         @RequestBody RequestCategoryDto entity) {
