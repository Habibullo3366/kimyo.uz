...
import static com.company.kimyouz.constants.SwaggerConstans.EXAMPLE_BASKET_NOT_FOUND;
import static com.company.kimyouz.constants.SwaggerConstans.EXAMPLE_BASKET_SUCCESS;
...
public class BasketController implements SimpleRequestCrud<Integer, RequestBasketDto, ResponseBasketDto> {
    ...
    @ApiResponses(
            value = {
                    ...
                    @ApiResponse(
                            description = "Basket API Success Post Method",
                            responseCode = "404",
                            content = @Content(
                                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                                    schema = @Schema(
