...
//import com.Jwts.JwtsFilter.repository.UserAccessSessionRepository;
                        ...
                        .ifPresent(userAccessSession -> {
                                    SecurityContextHolder.getContext().setAuthentication(
                                            new UsernamePasswordAuthenticationToken(
                                                    userAccessSession.getUsersDto(),
                                                    userAccessSession.getUsersDto().getPassword(),
                                                    userAccessSession.getUsersDto().getAuthorities()
                                            )
                                    );
                                }
                        );
